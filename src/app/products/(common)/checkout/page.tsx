...
const Checkout = (
 ...
 // fetch cart data either from server or localstorage
  ...
  return (
    <div className={`${assistant.className} bg-white w-full  flex justify-center mt-28 mb-20 `}>
      <div className=' w-[90%] flex flex-col-reverse md:flex-row gap-4 justify-center border rounded-md shadow- border-t-4 border-t-blue-context'>
        <div className='w-full  md:w-[50%]  p-4  py-10 md:pr-12'>
          <form action={handleCheckout}>
            <div>
              ...
              <div className='mb-4 flex flex-col gap-4 lg:flex-row justify-between '>
        ...
        <div className='w-full md:w-[50%] divide-y bg-gray-100 py-10 px-4 lg:p-10 '>
           <div className='mb-12 flex flex-col gap-4 justify-center items-center w-full'>
               <CartProduct disabledNumberInput={false} />
           </div>
          <div className='pt-10                          '>
             <OrderSummary />
          </div>
