...
const VideoSection = () => {
  ...
  return (
         <div className="relative flex w-full h-[40rem] overflow-hidden">
                <video autoPlay loop muted className="w-fit h-fit"  ref={ref}>
               ...
               <div className="absolute top-0 right-0 left-0 bottom-0 bg-black/70 text-white">
                 <div className="w-full h-full my-auto  flex justify-center items-center  ">
                  <div className=" flex flex-col items-center justify-between h-[80%] w-[90%] pt-10">
                    ...
                    <div className="flex justify-end w-full">
                          <button className='flex items-center justify-center gap-3 py-3 px-4 bg-black/90 hover:bg-black/40 mr-20'
