  ...
  return (
    ...
    <div className="mt-10 sm:mx-auto min-w-full">
      ...
      <div className=' flex flex-col sm:flex-row  justify-between gap-6 w-full mt-10' >
        <Link href={'#'} className='flex content-center border  max-h-fit min-w-fit  shadow-md rounded-md border-gray-300 bg-[#4267B2]  text-white hover:bg-[#5376bb] '>
          <span className='text-2xl font-extrabold  p-2 mr-2 bg-[#2b53a3] shadow-md'> <ImFacebook/> </span>
          <span className='pr-2 self-center text-sm'> Login with Facebook  </span>
        </Link>
         
        <Link href={'#'} className='flex content-center border max-h-fit min-w-fit   shadow-md rounded-md border-gray-300 bg-[#DB4437] text-white hover:bg-[#e65f53]'><span></span>
          <span className='text-2xl font-extrabold  p-2 mr-2 bg-[#c51707] shadow-md'> <ImGooglePlus/> </span>
